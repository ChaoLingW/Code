...
public class AccountImpl implements IAccountDao {
	...
	public int updataAccount(int outAccount, int inAccount, int money) {
		...
		String sql1 = "update account set accountmoney = accountmoney - ? where accountid = ?";
		String sql2 = "update account set accountmoney = accountmoney + ? where accountid = ?";
...
System.out.println(10/0);
	...
	@Override
	public int updataAccount(int account, int money) {
		int count = 0;
