...
public class StudentHomework2 {
	...
	// 通过形参完成对成员变量的赋值操作
	public StudentHomework2(String sNO, String sName, String sSex, int sAge, int sJava) {
		super();
		this.sNO = sNO;
		this.sName = sName;
		this.sSex = sSex;
	...
	//计算并输出最大值和最小值与平均值
	public static void value(StudentHomework2[] student) {
