...
public class Day0710 {
	...
	public static void test1() {
		...
		/*
		 * //方式二 for(int i = 0; i < a.length/2; i++){
		 * 
		 * //交换 temp = a[i]; a[i] = a[a.length -1-i]; a[a.length -1-i] = temp;
		 * 
		 * }
		 */
	}
	...
	public static void test7() {
		...
		// 方式一
		/*
		 * int sum = 0; double avg = 0.0; int max = 0; int min = -1; Scanner sc
